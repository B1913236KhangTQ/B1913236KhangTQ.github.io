 ...
 */
LANGUAGES_ARRAY = new Array("ENG", "VNM"); //all suported languages have to be written in this array. NOTE that the classnames have to be equal to these entries
FLAGS_PATH = "/js/pictures/"; //the path where all the pictures of the flages are. NOTE that image name has to be GER.jpg like you defined it in the array "LANGUAGES_ARRAY" above
DEFAULT_LANGUAGE = "ENG"; //set the default language
